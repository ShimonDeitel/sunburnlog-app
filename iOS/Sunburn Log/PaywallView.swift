    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 24) {
                ...
                Text("Sunburn Log Pro")
                    .font(Theme.titleFont)
                    .foregroundStyle(Theme.ink)

                Text("Photo timeline comparison and healing-duration stats")
                    .font(Theme.bodyFont)
                ...
                VStack(spacing: 12) {
                    ...
                    Label("Photo timeline comparison and healing-duration stats", systemImage: "sparkles")
                }
                .font(.subheadline)
